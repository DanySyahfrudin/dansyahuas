...
<head>
  ...
  <title>Rumah Sakit Dan | Login</title>
  ...
  body {
    ...
    background-image: url('https://images.unsplash.com/photo-1588776814546-a282c1df1226'); /* gambar rumah sakit */
  ...
  .login-logo a {
    background-color: #3399cc; /* biru laut */
    padding: 10px 15px;
    border-radius: 10px;
    font-weight: bold;
    color: black;
