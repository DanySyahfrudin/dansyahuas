...
<style>
  ...
  .main-sidebar .nav-link.active {
    background-color: #00264d !important; /* lebih gelap dari biru tua */
    color: white !important;
  }

  .brand-link {
    background-color: #004080 !important; /* biru tua yang lebih terang */
    color: white !important;
    font-family: 'Times New Roman', Times, serif !important;
  }
</style>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link d-flex flex-column align-items-center justify-content-center" style="text-align: center;">
      <img src="<?= base_url('assets/images/logo.jpeg'); ?>" alt="Suster Cantik" style="width: 80px; height: 80px; object-fit: cover; border-radius: 50%;">
